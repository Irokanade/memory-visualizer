...
// L2 DTLB: 64 sets x 4 ways = 256 entries (main DTLB for 4KB pages, 8-cycle
// miss penalty) ITLB:    32 sets x 4 ways = 128 entries No unified STLB on
// Conroe/Merom (added in Sandy Bridge)
